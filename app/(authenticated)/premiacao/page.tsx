...
const PRIZE_ROWS = [
  {
    ...
    tone: "gold",
    title: "Principal",
    subtitle: "1º ao 2.506º lugar",
    prize: "60%",
    share: "Tabela por posição",
  },
  {
    place: "10",
    tone: "silver",
    ...
    prize: "60%",
    share: "Top 10 proporcional",
  },
  {
    place: "4",
    tone: "bronze",
    title: "Pontuação",
    subtitle: "Exato, vencedor e gols",
    prize: "6 pts",
    share: "Placar exato",
  },
  {
    ...
    tone: "dark",
    title: "Desempate",
    subtitle: "6 critérios oficiais",
    prize: "Streak",
    share: "Sequência decide",
  },
  {
    place: "$",
    tone: "dark",
    title: "Pagamento",
    subtitle: "Saldo principal",
    prize: "Auto",
    share: "Ao fechar jogos",
  },
] as const;
