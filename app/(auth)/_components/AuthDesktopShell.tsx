  ...
  return (
    <main className="relative min-h-dvh overflow-hidden bg-black text-white">
      <section className={`grid min-h-dvh ${isCentered ? "lg:grid-cols-1" : "lg:grid-cols-[55%_45%]"}`}>
        ...
        <div className={`relative flex h-dvh min-h-dvh items-start justify-center overflow-y-auto overflow-x-hidden px-[26px] pb-10 pt-[118px] lg:items-center lg:px-5 lg:py-10 ${isCentered ? "bg-black" : "bg-[#050505]"}`}>
          {!isCentered && (
            <>
              <Image
                src={overlayTop}
